      ...
      <div className="contact-container">
        ...
        <div className="contact-flex">
          <div className="contact-box">
            <h4>Email</h4>
            <p>
              <a href="mailto:shiva.v16161@mail.com" data-cursor="disable">
          ...
          <div className="contact-box">
            ...
            <a
              href="linkedin.com/in/shivamani-kotagiri-1380a426a"
              target="_blank"
              data-cursor="disable"
              className="contact-social"
            >
          ...
          <div className="contact-box">
            <h2>
              Designed and Developed <br /> by <span>Shivamnai kotagiri</span>
            </h2>
            <h5>
              <MdCopyright /> 2024
            </h5>
